...
const Sidebar = () => {
  ...
  const menuItems = [
    ...
    { name: 'Student Enrolled', path: '/educator/student-enrolled', icon: 'https://www.shutterstock.com/image-vector/user-check-isolated-vector-icon-600nw-2318918187.jpg' },
  ]
  return isEducator && (
