      ...
      <form onSubmit={handleSubmit}
        ...
        <div className='flex flex-col gap-1'>
          ...
          <input onChange={e => setCourseTitle(e.target.value)} value={courseTitle}
            type="text" placeholder='Type Here' className='outline-nonne md:py-2.5 py-2 px-3 rounded border border-gray-500' required />
        </div>
        ...
        <div className='flex items-center justify-between flex-wrap'>
          <div className='flex flex-col gap-1'>
            <p>Course Price</p>
            <input onChange={e => setCoursePrice(e.target.value)} value={coursePrice} type="number" placeholder='0' className='outline-nonne md:py-2.5 w-28 py-2 px-3 rounded border border-gray-500' required />
          </div>
        ...
        <div className='flex flex-col gap-1'>
          <p>Discount %</p>
          <input onChange={e => setDiscount(e.target.value)} value={discount} type="number" placeholder='0' min={0} max={100} className='outline-nonne md:py-2.5 w-28 py-2 px-3 rounded border border-gray-500' required />
        </div>
                ...
                <div className='p-4'>
                  {chapter.chapterContent.map((lecture, lectureIndex) => (
                    <div key={lectureIndex} className='flex justify-between items-center mb-2'>
                      <span>
                        {lectureIndex + 1} {lecture.lectureTitle} - {lecture.lectureDuration} mins - <a target='_blank' className='text-blue-500' href={lecture.lectureUrl}>Link</a> - {lecture.isPreviewFree ? 'Free Preview' : 'Paid'}
                      </span>
