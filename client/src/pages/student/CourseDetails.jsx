...
const CourseDetails = () => {
  ...
  return courseData ? (
    ...
    <>
      <div className='flex md:flex-row flex-col-reverse gap-10 relative items-start justify-between md:px-36 px-8 md:pt-32 pt-[53px] text-left bg-gradient-to-b from-cyan-50/70'>

        {/* <div className='absolute top-0 left-0 w-full -z-10 bg-gradient-to-b from-cyan-100/70 '></div> */}

        {/* left column */}
        <div className='max-w-xl z-10 text-gray-500'>
          <h1 className='md:text-[44px] text-[36px] font-semibold text-gray-800'>{courseData.courseTitle}</h1>
                ...
                <div key={index} className='border border-gray-300 bg-white mb-2 rounded'>
                  <div className='flex items-center justify-between px-4 py-3 cursor-pointer select-none' onClick={() => toggleSection(index)}>
                    <div className='flex items-center gap-2'>
                      <img className={`tranform transition-tranform ${openSections[index] ? 'rotate-180' : ''}`}
        ...
        <div className='max-w-[424px] z-10 shadow-[0_4px_15px_2px_rgba(0,0,0,0.1)] rounded-t md:rounded-none overflow-hidden bg-white min-w-[300px] sm:min-w-[420px] '>
          ...
          <div className='p-5'>
            ...
            <button onClick={enrollCourse}
             className='md:mt-6 mt-4 w-full py-3 rounded bg-blue-600 text-white font-medium'> {isAlreadyEnrolled ? 'Already Enrolled' : 'Enroll Now'} </button>

            <div className='pt-6'>
              <p className='md:text-xl font-medium text-gray-800'>What's in course ?</p>
